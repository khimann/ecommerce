            ...
            <div class="row" style="margin-top: 30px;">
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 col-12">
                    <div class="contuct-detail mb-50 p-20 bg-fff box-shadow">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris convallis sed neque vitae
                            bibendum. Nunc auctor dictum risus, a finibus eros iaculis nec. Sed et euismod felis, non
                            euismod est. Maecenas quis nulla ullamcorper, imperdiet lacus et, porta sem.</p>
                        <div class="same">
